"use client"; // 1. Add "use client" at the top
...
// 4. Create a new component for the conditional button
const CtaButton = ({ size = 'lg', className = '' }) => {
  ...
  const handleClick = () => {
    if (status === 'authenticated') {
      router.push('/dashboard'); // If signed in, go to dashboard
    } else {
      router.push('/auth/signup'); // If not signed in, go to sign up page
    }
  };
  ...
  return (
    <Button 
      ...
      onClick={handleClick}
      disabled={status === 'loading'} // Disable button while checking auth status
    >
      {status === 'loading' ? (
    ...
    <div className="bg-white">
        ...
        <div className="relative z-30 max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              {/* 5. Replace the static Button with the new CtaButton component */}
              <CtaButton size="lg" className="px-8 py-3" />
              <Button size="lg" className="bg-gray-700/50 hover:bg-gray-600/50 text-white px-8 py-3 border border-gray-500">
                See How It Works
              </Button>
            </div>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          {/* 6. Replace the second CTA button as well */}
          <CtaButton size="lg" className="px-8 py-4 text-lg" />
